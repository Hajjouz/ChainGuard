...
#[derive(Debug)]
pub struct ChainGuardProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainGuardProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainGuard processing");
    
    let mut processor = ChainGuardProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainGuardProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainGuardProcessor::new(false);
